    ...
    class WriteLogs
    {
        ...
        public int DoWriteTestHistoryEnd(ref mystructHistoryInfo myHistoryInfo, mystructAccountCreate myAccountCreate, mystructApplication myApplication)
        {
            ...
            try
            {
                ...
                doc.InsertParagraph("Application Data, Address line 1: " + myApplication.myAddress1);
                doc.InsertParagraph("Application Data, Address line 2: " + myApplication.myAddress2);
                doc.InsertParagraph("Application Data, City: " + myApplication.myCity);
                doc.InsertParagraph("Application Data, State: " + myApplication.myState);
                doc.InsertParagraph("Application Data, Zip: " + myApplication.myZip);
                doc.InsertParagraph("Application Data, Zip + 4: " + myApplication.myZip4);
                doc.InsertParagraph("Application Data, Is your address same: " + myApplication.myAddressSame);
                doc.InsertParagraph("Application Data, County: " + myApplication.myCounty);
                doc.InsertParagraph("Application Data, Apt or Suite: " + myApplication.myAptSuite);
