...
namespace MNsure_Regression_1
{
    public partial class FormMain : Form
    {
        ...
        private void buttonGo_Click(object sender, EventArgs e)
        {
            ...
            myExistingAccountInfo.myExistingAccountFirstName = new string[250];
            myExistingAccountInfo.myExistingAccountMiddleName = new string[250];
            myExistingAccountInfo.myExistingAccountLastName = new string[250];
            myExistingAccountInfo.myExistingAccountSuffix = new string[250];
            myExistingAccountInfo.myExistingAccountAddress1 = new string[250];
            myExistingAccountInfo.myExistingAccountAddress2 = new string[250];
            myExistingAccountInfo.myExistingAccountCity = new string[250];
            myExistingAccountInfo.myExistingAccountState = new string[250];
            myExistingAccountInfo.myExistingAccountZip = new string[250];
            myExistingAccountInfo.myExistingAccountZip4 = new string[250];
            myExistingAccountInfo.myExistingAccountEmail = new string[250];
            myExistingAccountInfo.myExistingAccountPhone = new string[250];
            myExistingAccountInfo.myExistingAccountSSN = new string[250];
            myExistingAccountInfo.myExistingAccountDOB = new string[250];
            myExistingAccountInfo.myExistingAccountUserName = new string[250];
            myExistingAccountInfo.myExistingAccountPassword = new string[250];
            myExistingAccountInfo.myExistingAccountSecret = new string[250];
            myExistingAccountInfo.myExistingAccountQuestion1 = new string[250];
            myExistingAccountInfo.myExistingAccountAnswer1 = new string[250];
            myExistingAccountInfo.myExistingAccountQuestion2 = new string[250];
            myExistingAccountInfo.myExistingAccountAnswer2 = new string[250];
            myExistingAccountInfo.myExistingAccountQuestion3 = new string[250];
            myExistingAccountInfo.myExistingAccountAnswer3 = new string[250];
            myExistingAccountInfo.myExistingAccountQuestion4 = new string[250];
            myExistingAccountInfo.myExistingAccountAnswer4 = new string[250];
            myExistingAccountInfo.myExistingAccountQuestion5 = new string[250];
            myExistingAccountInfo.myExistingAccountAnswer5 = new string[250];
            myExistingAccountInfo.myExistingAccountConfirmation = new string[250];
